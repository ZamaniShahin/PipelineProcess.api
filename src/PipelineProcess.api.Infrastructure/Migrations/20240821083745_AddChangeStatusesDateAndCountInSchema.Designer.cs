...
namespace PipelineProcess.api.Infrastructure.Migrations
{
    ...
    [Migration("20240821083745_AddChangeStatusesDateAndCountInSchema")]
    partial class AddChangeStatusesDateAndCountInSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PipelineProcess.api.Core.Aggregates.FactoryAggregate.Factory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(64)
            ...
            modelBuilder.Entity("PipelineProcess.api.Core.SharedEntities.ProcessSheetEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("AdminAcceptStatusChangedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("PipelineProcess.api.Core.Aggregates.ProcessAggregate.Process", b =>
                {
                    b.HasOne("PipelineProcess.api.Core.Aggregates.FactoryAggregate.Factory", "Factory")
                        .WithMany("Processes")
