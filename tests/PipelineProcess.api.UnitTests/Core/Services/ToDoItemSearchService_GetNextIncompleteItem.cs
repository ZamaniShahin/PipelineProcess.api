...
using PipelineProcess.api.Core.ProjectAggregate;
using PipelineProcess.api.Core.Services;
using PipelineProcess.api.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace PipelineProcess.api.UnitTests.Core.Services
{
